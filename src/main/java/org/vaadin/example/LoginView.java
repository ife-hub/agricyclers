...
public class LoginView extends VerticalLayout {
    ...
    public VerticalLayout createLeftLayout(){
        ...
        H1 line2 = new H1("Welcome back 👋");
        line2.addClassName("signUpLine2");
        line2.setWidthFull();

        H1 line3 = new H1("Kindly fill in your details below to Log in");
        ...
        Button line10 = new Button("Login");
        ...
        Button line12 = new Button("Login with Google", googleImage);
        line12.addClassName("signUpSubmitButton2");

        RouterLink line13 = new RouterLink("Don't have an account?", SignUpView.class);
        line13.addClassName("signUpLine13");

        vl.add(line2, line3, line5, line7, line8, line9, line10, line11, line12,
                line13);
